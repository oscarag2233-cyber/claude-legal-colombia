...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Estudiante de Derecho, cuando se quiere que
...
# Espacio de asunto — Estudiante de Derecho
...
```
~/.claude/plugins/config/claude-legal-colombia/estudiante-derecho-co/
...
| Uso | Qué hace |
|---|---|
| `/estudiante-derecho-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/estudiante-derecho-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/estudiante-derecho-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/estudiante-derecho-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/estudiante-derecho-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/estudiante-derecho-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
