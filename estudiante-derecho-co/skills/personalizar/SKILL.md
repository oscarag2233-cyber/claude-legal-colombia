...
name: personalizar
description: >
  Ajusta el perfil de práctica de Estudiante de Derecho sin repetir la entrevista completa: cambiar
...
# Personalizar — Estudiante de Derecho

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/estudiante-derecho-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/estudiante-derecho-co:entrevista-inicial`?»
