...
description: >
  Entrevista de arranque del plugin Estudiante de Derecho. Levanta el perfil de la organización, el
...
2. `~/.claude/plugins/config/claude-legal-colombia/estudiante-derecho-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Formación jurídica de pregrado y preparación de exámenes preparatorios?»
