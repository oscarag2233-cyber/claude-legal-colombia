...
description: >
  Compuerta de verificación de fuentes para Estudiante de Derecho. Toma una pieza ya redactada —un
...
# Verificar citas — Estudiante de Derecho
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/estudiante-derecho-co/bitacora-verificacion.md` para que la
