...
2. Si ese archivo no existe o todavía tiene marcadores [PENDIENTE], DETENERSE antes
   ...
   /gobernanza-ia-co:entrevista-inicial — toma entre 10 y 15 minutos y todo lo demás depende de
   ...
   corren sin configuración son /gobernanza-ia-co:entrevista-inicial y cualquier invocación con
...
4. En la primera ejecución después de una actualización, si existe un CLAUDE.md
   ...
   (~/.claude/plugins/cache/claude-legal-colombia/gobernanza-ia-co/<versión>/CLAUDE.md) pero no en la ruta de
...
|---|---|---|
| Gestor documental | [PENDIENTE ✓/✗] | El inventario y las evaluaciones se guardan por fuera |
| Gestor de tareas | [PENDIENTE ✓/✗] | Los hallazgos se cargan manualmente |

*Revisar de nuevo: `/gobernanza-ia-co:entrevista-inicial --revisar-integraciones`*
...
- Superintendencia de Industria y Comercio (datos personales y consumidor)
- Ministerio de Ciencia, Tecnología e Innovación y MinTIC
...
#### Quién aprueba un nuevo caso de uso de IA
**Posición:** [PENDIENTE]
...
`~/.claude/plugins/config/claude-legal-colombia/gobernanza-ia-co/bitacora-verificacion.md` en una línea:
...
en `~/.claude/plugins/config/claude-legal-colombia/gobernanza-ia-co/asuntos/<slug>/` con su `asunto.md`, y las skills escriben ahí.

`Contexto entre asuntos:` off *(por defecto)* — no se leen archivos de otro asunto.

Ver `/gobernanza-ia-co:espacio-de-asunto`.
