...
description: >
  Entrevista de arranque del plugin Gobernanza de Inteligencia Artificial. Levanta el perfil de la organización, el
...
# Entrevista inicial — Gobernanza de Inteligencia Artificial
...
2. `~/.claude/plugins/config/claude-legal-colombia/gobernanza-ia-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Gobernanza, riesgo y cumplimiento de sistemas de inteligencia artificial en Colombia?»
