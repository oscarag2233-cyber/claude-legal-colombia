...
name: personalizar
description: >
  Ajusta el perfil de práctica de Gobernanza de Inteligencia Artificial sin repetir la entrevista completa: cambiar
...
# Personalizar — Gobernanza de Inteligencia Artificial

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/gobernanza-ia-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/gobernanza-ia-co:entrevista-inicial`?»
