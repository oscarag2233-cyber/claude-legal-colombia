...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Gobernanza de Inteligencia Artificial, cuando se quiere que
...
# Espacio de asunto — Gobernanza de Inteligencia Artificial
...
```
~/.claude/plugins/config/claude-legal-colombia/gobernanza-ia-co/
...
| Uso | Qué hace |
|---|---|
| `/gobernanza-ia-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/gobernanza-ia-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/gobernanza-ia-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/gobernanza-ia-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/gobernanza-ia-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/gobernanza-ia-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
