...
description: >
  Compuerta de verificación de fuentes para Gobernanza de Inteligencia Artificial. Toma una pieza ya redactada —un
...
# Verificar citas — Gobernanza de Inteligencia Artificial
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/gobernanza-ia-co/bitacora-verificacion.md` para que la
