...
description: >
  Compuerta de verificación de fuentes para Consumidor y Competencia. Toma una pieza ya redactada —un
...
# Verificar citas — Consumidor y Competencia
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/consumidor-competencia-co/bitacora-verificacion.md` para que la
