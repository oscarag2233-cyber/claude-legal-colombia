...
description: >
  Entrevista de arranque del plugin Consumidor y Competencia. Levanta el perfil de la organización, el
...
# Entrevista inicial — Consumidor y Competencia
...
2. `~/.claude/plugins/config/claude-legal-colombia/consumidor-competencia-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Protección al consumidor, publicidad, prácticas restrictivas de la competencia y competencia desleal?»
