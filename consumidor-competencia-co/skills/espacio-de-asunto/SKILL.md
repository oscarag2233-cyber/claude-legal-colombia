...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Consumidor y Competencia, cuando se quiere que
...
# Espacio de asunto — Consumidor y Competencia
...
```
~/.claude/plugins/config/claude-legal-colombia/consumidor-competencia-co/
...
| Uso | Qué hace |
|---|---|
| `/consumidor-competencia-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/consumidor-competencia-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/consumidor-competencia-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/consumidor-competencia-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/consumidor-competencia-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/consumidor-competencia-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
