...
name: personalizar
description: >
  Ajusta el perfil de práctica de Consumidor y Competencia sin repetir la entrevista completa: cambiar
...
# Personalizar — Consumidor y Competencia

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/consumidor-competencia-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/consumidor-competencia-co:entrevista-inicial`?»
