...
name: personalizar
description: >
  Ajusta el perfil de práctica de Contencioso Administrativo y Contratación Estatal sin repetir la entrevista completa: cambiar
...
# Personalizar — Contencioso Administrativo y Contratación Estatal

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/contencioso-administrativo-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/contencioso-administrativo-co:entrevista-inicial`?»
