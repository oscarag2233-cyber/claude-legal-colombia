...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Contencioso Administrativo y Contratación Estatal, cuando se quiere que
...
# Espacio de asunto — Contencioso Administrativo y Contratación Estatal
...
```
~/.claude/plugins/config/claude-legal-colombia/contencioso-administrativo-co/
...
| Uso | Qué hace |
|---|---|
| `/contencioso-administrativo-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/contencioso-administrativo-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/contencioso-administrativo-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/contencioso-administrativo-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/contencioso-administrativo-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/contencioso-administrativo-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
