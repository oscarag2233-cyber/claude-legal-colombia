...
description: >
  Entrevista de arranque del plugin Contencioso Administrativo y Contratación Estatal. Levanta el perfil de la organización, el
...
# Entrevista inicial — Contencioso Administrativo y Contratación Estatal
...
2. `~/.claude/plugins/config/claude-legal-colombia/contencioso-administrativo-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Derecho administrativo, contencioso administrativo y contratación estatal?»
