...
description: >
  Compuerta de verificación de fuentes para Contencioso Administrativo y Contratación Estatal. Toma una pieza ya redactada —un
...
# Verificar citas — Contencioso Administrativo y Contratación Estatal
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/contencioso-administrativo-co/bitacora-verificacion.md` para que la
