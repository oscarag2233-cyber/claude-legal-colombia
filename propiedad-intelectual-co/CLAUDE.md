...
2. Si ese archivo no existe o todavía tiene marcadores [PENDIENTE], DETENERSE antes
   ...
   /propiedad-intelectual-co:entrevista-inicial — toma entre 10 y 15 minutos y todo lo demás depende de
   ...
   corren sin configuración son /propiedad-intelectual-co:entrevista-inicial y cualquier invocación con
...
4. En la primera ejecución después de una actualización, si existe un CLAUDE.md
   ...
   (~/.claude/plugins/cache/claude-legal-colombia/propiedad-intelectual-co/<versión>/CLAUDE.md) pero no en la ruta de
...
# Perfil de práctica — Propiedad Intelectual
...
|---|---|---|
| Gestor documental | [PENDIENTE ✓/✗] | El usuario adjunta certificados, publicaciones y evidencias de uso |
| Base de datos de marcas de la SIC | [PENDIENTE ✓/✗] | La búsqueda de antecedentes la hace el usuario y aporta el resultado |
| Calendario | [PENDIENTE ✓/✗] | Los vencimientos se entregan en tabla |

*Revisar de nuevo: `/propiedad-intelectual-co:entrevista-inicial --revisar-integraciones`*
...
#### Umbral para presentar oposición frente a coexistir
**Posición:** [PENDIENTE]
...
`~/.claude/plugins/config/claude-legal-colombia/propiedad-intelectual-co/bitacora-verificacion.md` en una línea:
...
en `~/.claude/plugins/config/claude-legal-colombia/propiedad-intelectual-co/asuntos/<slug>/` con su `asunto.md`, y las skills escriben ahí.

`Contexto entre asuntos:` off *(por defecto)* — no se leen archivos de otro asunto.

Ver `/propiedad-intelectual-co:espacio-de-asunto`.
