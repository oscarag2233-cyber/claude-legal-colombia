...
name: personalizar
description: >
  Ajusta el perfil de práctica de Propiedad Intelectual sin repetir la entrevista completa: cambiar
...
# Personalizar — Propiedad Intelectual

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/propiedad-intelectual-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/propiedad-intelectual-co:entrevista-inicial`?»
