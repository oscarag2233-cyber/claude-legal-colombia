...
description: >
  Entrevista de arranque del plugin Propiedad Intelectual. Levanta el perfil de la organización, el
...
# Entrevista inicial — Propiedad Intelectual
...
2. `~/.claude/plugins/config/claude-legal-colombia/propiedad-intelectual-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Propiedad industrial (marcas, patentes, diseños), derecho de autor y derechos conexos, secretos empresariales?»
...
- Gestor documental
- Base de datos de marcas de la SIC
- Calendario
