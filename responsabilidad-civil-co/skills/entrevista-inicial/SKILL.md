...
description: >
  Entrevista de arranque del plugin Responsabilidad Civil y Seguros. Levanta el perfil de la organización, el
...
# Entrevista inicial — Responsabilidad Civil y Seguros
...
2. `~/.claude/plugins/config/claude-legal-colombia/responsabilidad-civil-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Responsabilidad civil contractual y extracontractual, actividades peligrosas, responsabilidad médica y de tránsito, seguros de daños y de responsabilidad?»
...
- [las posiciones de la sección `## Criterios de la casa` de la plantilla]
...
- Hoja de cálculo para liquidaciones
