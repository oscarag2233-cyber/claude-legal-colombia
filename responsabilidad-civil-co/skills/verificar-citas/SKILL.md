...
description: >
  Compuerta de verificación de fuentes para Responsabilidad Civil y Seguros. Toma una pieza ya redactada —un
...
# Verificar citas — Responsabilidad Civil y Seguros
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/responsabilidad-civil-co/bitacora-verificacion.md` para que la
