...
name: personalizar
description: >
  Ajusta el perfil de práctica de Responsabilidad Civil y Seguros sin repetir la entrevista completa: cambiar
...
# Personalizar — Responsabilidad Civil y Seguros

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/responsabilidad-civil-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/responsabilidad-civil-co:entrevista-inicial`?»
