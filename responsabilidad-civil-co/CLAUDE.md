...
2. Si ese archivo no existe o todavía tiene marcadores [PENDIENTE], DETENERSE antes
   ...
   /responsabilidad-civil-co:entrevista-inicial — toma entre 10 y 15 minutos y todo lo demás depende de
   ...
   corren sin configuración son /responsabilidad-civil-co:entrevista-inicial y cualquier invocación con
...
4. En la primera ejecución después de una actualización, si existe un CLAUDE.md
   ...
   (~/.claude/plugins/cache/claude-legal-colombia/responsabilidad-civil-co/<versión>/CLAUDE.md) pero no en la ruta de
...
# Perfil de práctica — Responsabilidad Civil y Seguros
...
|---|---|---|
| Gestor documental | [PENDIENTE ✓/✗] | El usuario adjunta historia clínica, informes de tránsito o pericias en cada análisis |
| Consulta de procesos de la Rama Judicial | [PENDIENTE ✓/✗] | El seguimiento del proceso se hace manualmente |
| Hoja de cálculo para liquidaciones | [PENDIENTE ✓/✗] | La liquidación se entrega en tabla dentro de la respuesta |

*Revisar de nuevo: `/responsabilidad-civil-co:entrevista-inicial --revisar-integraciones`*
...
`~/.claude/plugins/config/claude-legal-colombia/responsabilidad-civil-co/bitacora-verificacion.md` en una línea:
...
en `~/.claude/plugins/config/claude-legal-colombia/responsabilidad-civil-co/asuntos/<slug>/` con su `asunto.md`, y las skills escriben ahí.

`Contexto entre asuntos:` off *(por defecto)* — no se leen archivos de otro asunto.

Ver `/responsabilidad-civil-co:espacio-de-asunto`.
