...
description: >
  Compuerta de verificación de fuentes para Cumplimiento — SAGRILAFT, PTEE y Antisoborno. Toma una pieza ya redactada —un
...
# Verificar citas — Cumplimiento — SAGRILAFT, PTEE y Antisoborno
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/cumplimiento-co/bitacora-verificacion.md` para que la
