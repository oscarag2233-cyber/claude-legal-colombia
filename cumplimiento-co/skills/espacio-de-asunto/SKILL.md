...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Cumplimiento — SAGRILAFT, PTEE y Antisoborno, cuando se quiere que
...
# Espacio de asunto — Cumplimiento — SAGRILAFT, PTEE y Antisoborno
...
```
~/.claude/plugins/config/claude-legal-colombia/cumplimiento-co/
...
| Uso | Qué hace |
|---|---|
| `/cumplimiento-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/cumplimiento-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/cumplimiento-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/cumplimiento-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/cumplimiento-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/cumplimiento-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
