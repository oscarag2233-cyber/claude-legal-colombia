...
name: personalizar
description: >
  Ajusta el perfil de práctica de Cumplimiento — SAGRILAFT, PTEE y Antisoborno sin repetir la entrevista completa: cambiar
...
# Personalizar — Cumplimiento — SAGRILAFT, PTEE y Antisoborno

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/cumplimiento-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/cumplimiento-co:entrevista-inicial`?»
