...
description: >
  Entrevista de arranque del plugin Cumplimiento — SAGRILAFT, PTEE y Antisoborno. Levanta el perfil de la organización, el
...
# Entrevista inicial — Cumplimiento — SAGRILAFT, PTEE y Antisoborno
...
2. `~/.claude/plugins/config/claude-legal-colombia/cumplimiento-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Prevención de LA/FT/FPADM, transparencia y ética empresarial, antisoborno y anticorrupción privada?»
...
- Gestor documental
- Listas restrictivas y verificación de contrapartes
- Canal de denuncias
