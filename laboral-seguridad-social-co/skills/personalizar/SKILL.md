...
name: personalizar
description: >
  Ajusta el perfil de práctica de Laboral y Seguridad Social sin repetir la entrevista completa: cambiar
...
# Personalizar — Laboral y Seguridad Social

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/laboral-seguridad-social-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/laboral-seguridad-social-co:entrevista-inicial`?»
