...
description: >
  Compuerta de verificación de fuentes para Laboral y Seguridad Social. Toma una pieza ya redactada —un
...
# Verificar citas — Laboral y Seguridad Social
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/laboral-seguridad-social-co/bitacora-verificacion.md` para que la
