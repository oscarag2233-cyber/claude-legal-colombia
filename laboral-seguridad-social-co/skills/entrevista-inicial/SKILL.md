...
description: >
  Entrevista de arranque del plugin Laboral y Seguridad Social. Levanta el perfil de la organización, el
...
# Entrevista inicial — Laboral y Seguridad Social
...
2. `~/.claude/plugins/config/claude-legal-colombia/laboral-seguridad-social-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Derecho individual y colectivo del trabajo, seguridad social integral y riesgos laborales?»
