...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Laboral y Seguridad Social, cuando se quiere que
...
# Espacio de asunto — Laboral y Seguridad Social
...
```
~/.claude/plugins/config/claude-legal-colombia/laboral-seguridad-social-co/
...
| Uso | Qué hace |
|---|---|
| `/laboral-seguridad-social-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/laboral-seguridad-social-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/laboral-seguridad-social-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/laboral-seguridad-social-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/laboral-seguridad-social-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/laboral-seguridad-social-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
