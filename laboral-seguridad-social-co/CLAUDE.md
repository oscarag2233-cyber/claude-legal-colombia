...
2. Si ese archivo no existe o todavía tiene marcadores [PENDIENTE], DETENERSE antes
   ...
   /laboral-seguridad-social-co:entrevista-inicial — toma entre 10 y 15 minutos y todo lo demás depende de
   ...
   corren sin configuración son /laboral-seguridad-social-co:entrevista-inicial y cualquier invocación con
...
4. En la primera ejecución después de una actualización, si existe un CLAUDE.md
   ...
   (~/.claude/plugins/cache/claude-legal-colombia/laboral-seguridad-social-co/<versión>/CLAUDE.md) pero no en la ruta de
...
# Perfil de práctica — Laboral y Seguridad Social
...
|---|---|---|
| Sistema de nómina o HRIS | [PENDIENTE ✓/✗] | El usuario aporta los datos salariales para cada liquidación |
| Gestor documental | [PENDIENTE ✓/✗] | El usuario adjunta contrato, descargos y soportes |
| Correo | [PENDIENTE ✓/✗] | Las comunicaciones al trabajador se entregan como borrador |

*Revisar de nuevo: `/laboral-seguridad-social-co:entrevista-inicial --revisar-integraciones`*
...
- Jueces laborales del circuito y municipales de pequeñas causas
- Corte Suprema de Justicia, Sala de Casación Laboral
- UGPP (aportes)
- ARL, EPS y fondos de pensiones
...
#### Postura frente a la terminación sin justa causa con indemnización
**Posición:** [PENDIENTE]
...
`~/.claude/plugins/config/claude-legal-colombia/laboral-seguridad-social-co/bitacora-verificacion.md` en una línea:
...
en `~/.claude/plugins/config/claude-legal-colombia/laboral-seguridad-social-co/asuntos/<slug>/` con su `asunto.md`, y las skills escriben ahí.

`Contexto entre asuntos:` off *(por defecto)* — no se leen archivos de otro asunto.

Ver `/laboral-seguridad-social-co:espacio-de-asunto`.
