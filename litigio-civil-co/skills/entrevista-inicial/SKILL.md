...
description: >
  Entrevista de arranque del plugin Litigio Civil y Comercial. Levanta el perfil de la organización, el
...
# Entrevista inicial — Litigio Civil y Comercial
...
2. `~/.claude/plugins/config/claude-legal-colombia/litigio-civil-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Proceso civil, comercial y de familia en la jurisdicción ordinaria; arbitraje?»
