...
name: personalizar
description: >
  Ajusta el perfil de práctica de Litigio Civil y Comercial sin repetir la entrevista completa: cambiar
...
# Personalizar — Litigio Civil y Comercial

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/litigio-civil-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/litigio-civil-co:entrevista-inicial`?»
