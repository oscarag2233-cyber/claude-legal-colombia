...
description: >
  Compuerta de verificación de fuentes para Litigio Civil y Comercial. Toma una pieza ya redactada —un
...
# Verificar citas — Litigio Civil y Comercial
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/litigio-civil-co/bitacora-verificacion.md` para que la
