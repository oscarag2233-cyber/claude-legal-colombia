...
description: >
  Compuerta de verificación de fuentes para Familia y Sucesiones. Toma una pieza ya redactada —un
...
# Verificar citas — Familia y Sucesiones
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/familia-sucesiones-co/bitacora-verificacion.md` para que la
