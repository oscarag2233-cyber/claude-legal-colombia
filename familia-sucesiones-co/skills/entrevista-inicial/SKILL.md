...
description: >
  Entrevista de arranque del plugin Familia y Sucesiones. Levanta el perfil de la organización, el
...
# Entrevista inicial — Familia y Sucesiones
...
2. `~/.claude/plugins/config/claude-legal-colombia/familia-sucesiones-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Derecho de familia, infancia y adolescencia, régimen económico de la pareja y derecho sucesoral?»
