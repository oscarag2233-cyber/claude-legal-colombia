...
name: personalizar
description: >
  Ajusta el perfil de práctica de Familia y Sucesiones sin repetir la entrevista completa: cambiar
...
# Personalizar — Familia y Sucesiones

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/familia-sucesiones-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/familia-sucesiones-co:entrevista-inicial`?»
