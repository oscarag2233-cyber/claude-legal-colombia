...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Familia y Sucesiones, cuando se quiere que
...
# Espacio de asunto — Familia y Sucesiones
...
```
~/.claude/plugins/config/claude-legal-colombia/familia-sucesiones-co/
...
| Uso | Qué hace |
|---|---|
| `/familia-sucesiones-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/familia-sucesiones-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/familia-sucesiones-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/familia-sucesiones-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/familia-sucesiones-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/familia-sucesiones-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
