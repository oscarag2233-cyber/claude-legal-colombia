...
name: personalizar
description: >
  Ajusta el perfil de práctica de Tributario sin repetir la entrevista completa: cambiar
...
# Personalizar — Tributario

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/tributario-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/tributario-co:entrevista-inicial`?»
