...
description: >
  Compuerta de verificación de fuentes para Tributario. Toma una pieza ya redactada —un
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/tributario-co/bitacora-verificacion.md` para que la
