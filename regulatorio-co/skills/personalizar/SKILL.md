...
name: personalizar
description: >
  Ajusta el perfil de práctica de Regulatorio y Vigilancia Normativa sin repetir la entrevista completa: cambiar
...
# Personalizar — Regulatorio y Vigilancia Normativa

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/regulatorio-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/regulatorio-co:entrevista-inicial`?»
