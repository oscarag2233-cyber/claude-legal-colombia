...
description: >
  Entrevista de arranque del plugin Regulatorio y Vigilancia Normativa. Levanta el perfil de la organización, el
...
# Entrevista inicial — Regulatorio y Vigilancia Normativa
...
2. `~/.claude/plugins/config/claude-legal-colombia/regulatorio-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Vigilancia normativa y jurisprudencial, análisis de impacto regulatorio y gestión de obligaciones?»
