...
description: >
  Compuerta de verificación de fuentes para Regulatorio y Vigilancia Normativa. Toma una pieza ya redactada —un
...
# Verificar citas — Regulatorio y Vigilancia Normativa
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/regulatorio-co/bitacora-verificacion.md` para que la
