...
description: >
  Compuerta de verificación de fuentes para Inmobiliario y Propiedad Horizontal. Toma una pieza ya redactada —un
...
# Verificar citas — Inmobiliario y Propiedad Horizontal
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/inmobiliario-ph-co/bitacora-verificacion.md` para que la
