...
name: personalizar
description: >
  Ajusta el perfil de práctica de Inmobiliario y Propiedad Horizontal sin repetir la entrevista completa: cambiar
...
# Personalizar — Inmobiliario y Propiedad Horizontal

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/inmobiliario-ph-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/inmobiliario-ph-co:entrevista-inicial`?»
