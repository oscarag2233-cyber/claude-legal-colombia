...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Inmobiliario y Propiedad Horizontal, cuando se quiere que
...
# Espacio de asunto — Inmobiliario y Propiedad Horizontal
...
```
~/.claude/plugins/config/claude-legal-colombia/inmobiliario-ph-co/
...
| Uso | Qué hace |
|---|---|
| `/inmobiliario-ph-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/inmobiliario-ph-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/inmobiliario-ph-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/inmobiliario-ph-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/inmobiliario-ph-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/inmobiliario-ph-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
