...
description: >
  Entrevista de arranque del plugin Inmobiliario y Propiedad Horizontal. Levanta el perfil de la organización, el
...
# Entrevista inicial — Inmobiliario y Propiedad Horizontal
...
2. `~/.claude/plugins/config/claude-legal-colombia/inmobiliario-ph-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Derecho inmobiliario, registro, arrendamiento urbano y propiedad horizontal?»
