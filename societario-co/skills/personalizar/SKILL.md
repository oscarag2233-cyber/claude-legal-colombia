...
name: personalizar
description: >
  Ajusta el perfil de práctica de Societario sin repetir la entrevista completa: cambiar
...
# Personalizar — Societario

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/societario-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/societario-co:entrevista-inicial`?»
