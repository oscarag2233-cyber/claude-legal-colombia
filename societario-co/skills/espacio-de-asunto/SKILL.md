...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Societario, cuando se quiere que
...
```
~/.claude/plugins/config/claude-legal-colombia/societario-co/
...
| Uso | Qué hace |
|---|---|
| `/societario-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/societario-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/societario-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/societario-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/societario-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/societario-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
