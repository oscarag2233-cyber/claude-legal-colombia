...
description: >
  Compuerta de verificación de fuentes para Societario. Toma una pieza ya redactada —un
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/societario-co/bitacora-verificacion.md` para que la
