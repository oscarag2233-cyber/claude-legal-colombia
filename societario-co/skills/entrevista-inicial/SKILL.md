...
description: >
  Entrevista de arranque del plugin Societario. Levanta el perfil de la organización, el
...
2. `~/.claude/plugins/config/claude-legal-colombia/societario-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Derecho societario, gobierno corporativo y conflictos entre socios?»
