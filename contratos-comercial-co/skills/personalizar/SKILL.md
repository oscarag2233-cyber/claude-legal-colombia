...
name: personalizar
description: >
  Ajusta el perfil de práctica de Contratos y Derecho Comercial sin repetir la entrevista completa: cambiar
...
# Personalizar — Contratos y Derecho Comercial

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/contratos-comercial-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/contratos-comercial-co:entrevista-inicial`?»
