...
description: >
  Compuerta de verificación de fuentes para Contratos y Derecho Comercial. Toma una pieza ya redactada —un
...
# Verificar citas — Contratos y Derecho Comercial
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/contratos-comercial-co/bitacora-verificacion.md` para que la
