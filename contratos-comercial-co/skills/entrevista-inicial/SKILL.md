...
description: >
  Entrevista de arranque del plugin Contratos y Derecho Comercial. Levanta el perfil de la organización, el
...
# Entrevista inicial — Contratos y Derecho Comercial
...
2. `~/.claude/plugins/config/claude-legal-colombia/contratos-comercial-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Contratación civil y mercantil, obligaciones, garantías y remedios contractuales?»
...
- Gestor documental (Drive / Box / SharePoint)
- Firma electrónica
- Gestor de contratos o carpeta de minutas
- Correo y calendario
