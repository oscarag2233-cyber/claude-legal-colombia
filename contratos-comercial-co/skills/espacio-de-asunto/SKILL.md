...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Contratos y Derecho Comercial, cuando se quiere que
...
# Espacio de asunto — Contratos y Derecho Comercial
...
```
~/.claude/plugins/config/claude-legal-colombia/contratos-comercial-co/
...
| Uso | Qué hace |
|---|---|
| `/contratos-comercial-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/contratos-comercial-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/contratos-comercial-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/contratos-comercial-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/contratos-comercial-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/contratos-comercial-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
