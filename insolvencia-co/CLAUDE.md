...
2. Si ese archivo no existe o todavía tiene marcadores [PENDIENTE], DETENERSE antes
   ...
   /insolvencia-co:entrevista-inicial — toma entre 10 y 15 minutos y todo lo demás depende de
   ...
   corren sin configuración son /insolvencia-co:entrevista-inicial y cualquier invocación con
...
4. En la primera ejecución después de una actualización, si existe un CLAUDE.md
   ...
   (~/.claude/plugins/cache/claude-legal-colombia/insolvencia-co/<versión>/CLAUDE.md) pero no en la ruta de
...
# Perfil de práctica — Insolvencia y Reorganización
...
|---|---|---|
| Gestor documental | [PENDIENTE ✓/✗] | El usuario adjunta estados financieros y relación de acreedores |
| Hoja de cálculo | [PENDIENTE ✓/✗] | Los inventarios y la graduación se entregan en tabla |

*Revisar de nuevo: `/insolvencia-co:entrevista-inicial --revisar-integraciones`*
...
- Superintendencia de Sociedades (juez del concurso)
- Jueces civiles del circuito (en subsidio)
...
#### Cuándo se recomienda reorganización frente a liquidación
**Posición:** [PENDIENTE]
...
`~/.claude/plugins/config/claude-legal-colombia/insolvencia-co/bitacora-verificacion.md` en una línea:
...
en `~/.claude/plugins/config/claude-legal-colombia/insolvencia-co/asuntos/<slug>/` con su `asunto.md`, y las skills escriben ahí.

`Contexto entre asuntos:` off *(por defecto)* — no se leen archivos de otro asunto.

Ver `/insolvencia-co:espacio-de-asunto`.
