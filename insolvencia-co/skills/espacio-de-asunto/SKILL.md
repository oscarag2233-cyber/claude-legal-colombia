...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Insolvencia y Reorganización, cuando se quiere que
...
# Espacio de asunto — Insolvencia y Reorganización
...
```
~/.claude/plugins/config/claude-legal-colombia/insolvencia-co/
...
| Uso | Qué hace |
|---|---|
| `/insolvencia-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/insolvencia-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/insolvencia-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/insolvencia-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/insolvencia-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/insolvencia-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
