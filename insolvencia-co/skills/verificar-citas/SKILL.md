...
description: >
  Compuerta de verificación de fuentes para Insolvencia y Reorganización. Toma una pieza ya redactada —un
...
# Verificar citas — Insolvencia y Reorganización
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/insolvencia-co/bitacora-verificacion.md` para que la
