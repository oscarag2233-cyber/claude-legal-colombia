...
name: personalizar
description: >
  Ajusta el perfil de práctica de Insolvencia y Reorganización sin repetir la entrevista completa: cambiar
...
# Personalizar — Insolvencia y Reorganización

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/insolvencia-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/insolvencia-co:entrevista-inicial`?»
