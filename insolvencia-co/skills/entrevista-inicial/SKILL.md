...
description: >
  Entrevista de arranque del plugin Insolvencia y Reorganización. Levanta el perfil de la organización, el
...
# Entrevista inicial — Insolvencia y Reorganización
...
2. `~/.claude/plugins/config/claude-legal-colombia/insolvencia-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Régimen de insolvencia empresarial y de persona natural no comerciante?»
