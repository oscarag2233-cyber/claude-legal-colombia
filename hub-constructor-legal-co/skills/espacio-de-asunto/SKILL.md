...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Hub de Constructores Legales, cuando se quiere que
...
# Espacio de asunto — Hub de Constructores Legales
...
```
~/.claude/plugins/config/claude-legal-colombia/hub-constructor-legal-co/
...
| Uso | Qué hace |
|---|---|
| `/hub-constructor-legal-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/hub-constructor-legal-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/hub-constructor-legal-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/hub-constructor-legal-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/hub-constructor-legal-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/hub-constructor-legal-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
