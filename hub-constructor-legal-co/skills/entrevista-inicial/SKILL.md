...
description: >
  Entrevista de arranque del plugin Hub de Constructores Legales. Levanta el perfil de la organización, el
...
# Entrevista inicial — Hub de Constructores Legales
...
2. `~/.claude/plugins/config/claude-legal-colombia/hub-constructor-legal-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Gestión del ecosistema de skills jurídicas: descubrimiento, revisión, instalación y control de calidad?»
