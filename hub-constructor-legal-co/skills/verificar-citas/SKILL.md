...
description: >
  Compuerta de verificación de fuentes para Hub de Constructores Legales. Toma una pieza ya redactada —un
...
# Verificar citas — Hub de Constructores Legales
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/hub-constructor-legal-co/bitacora-verificacion.md` para que la
