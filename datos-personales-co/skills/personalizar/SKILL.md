...
name: personalizar
description: >
  Ajusta el perfil de práctica de Datos Personales y Habeas Data sin repetir la entrevista completa: cambiar
...
# Personalizar — Datos Personales y Habeas Data

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/datos-personales-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/datos-personales-co:entrevista-inicial`?»
