...
description: >
  Compuerta de verificación de fuentes para Datos Personales y Habeas Data. Toma una pieza ya redactada —un
...
# Verificar citas — Datos Personales y Habeas Data
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/datos-personales-co/bitacora-verificacion.md` para que la
