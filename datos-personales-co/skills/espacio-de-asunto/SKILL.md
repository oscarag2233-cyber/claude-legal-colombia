...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Datos Personales y Habeas Data, cuando se quiere que
...
# Espacio de asunto — Datos Personales y Habeas Data
...
```
~/.claude/plugins/config/claude-legal-colombia/datos-personales-co/
...
| Uso | Qué hace |
|---|---|
| `/datos-personales-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/datos-personales-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/datos-personales-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/datos-personales-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/datos-personales-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/datos-personales-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
