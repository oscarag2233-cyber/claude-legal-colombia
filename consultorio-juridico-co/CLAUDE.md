...
2. Si ese archivo no existe o todavía tiene marcadores [PENDIENTE], DETENERSE antes
   ...
   /consultorio-juridico-co:entrevista-inicial — toma entre 10 y 15 minutos y todo lo demás depende de
   ...
   corren sin configuración son /consultorio-juridico-co:entrevista-inicial y cualquier invocación con
...
4. En la primera ejecución después de una actualización, si existe un CLAUDE.md
   ...
   (~/.claude/plugins/cache/claude-legal-colombia/consultorio-juridico-co/<versión>/CLAUDE.md) pero no en la ruta de
...
|---|---|---|
| Gestor documental | [PENDIENTE ✓/✗] | Las fichas y conceptos se guardan en la carpeta del consultorio |
| Calendario | [PENDIENTE ✓/✗] | Los términos se entregan en tabla |

*Revisar de nuevo: `/consultorio-juridico-co:entrevista-inicial --revisar-integraciones`*
...
- Universidad y su facultad de Derecho
- Consejo Superior de la Judicatura (registro de consultorios)
- Ministerio de Justicia (centros de conciliación)
- Jueces y autoridades ante quienes actúa el consultorio
...
#### Alcance de la representación que asume el consultorio
**Posición:** [PENDIENTE]
...
`~/.claude/plugins/config/claude-legal-colombia/consultorio-juridico-co/bitacora-verificacion.md` en una línea:
...
en `~/.claude/plugins/config/claude-legal-colombia/consultorio-juridico-co/asuntos/<slug>/` con su `asunto.md`, y las skills escriben ahí.

`Contexto entre asuntos:` off *(por defecto)* — no se leen archivos de otro asunto.

Ver `/consultorio-juridico-co:espacio-de-asunto`.
