...
description: >
  Crea, cambia, lista y cierra espacios de asunto para Consultorio Jurídico, cuando se quiere que
...
# Espacio de asunto — Consultorio Jurídico
...
```
~/.claude/plugins/config/claude-legal-colombia/consultorio-juridico-co/
...
| Uso | Qué hace |
|---|---|
| `/consultorio-juridico-co:espacio-de-asunto habilitar` | Enciende la maquinaria de asuntos y lo registra en el perfil |
| `/consultorio-juridico-co:espacio-de-asunto crear <slug>` | Crea el asunto y hace la entrevista corta de contexto |
| `/consultorio-juridico-co:espacio-de-asunto cambiar <slug>` | Fija el asunto activo |
| `/consultorio-juridico-co:espacio-de-asunto listar` | Lista los asuntos con su estado y su próximo término |
| `/consultorio-juridico-co:espacio-de-asunto cerrar <slug>` | Cierra el asunto y deja la nota de cierre |
| `/consultorio-juridico-co:espacio-de-asunto practica` | Vuelve a trabajar a nivel de práctica |
