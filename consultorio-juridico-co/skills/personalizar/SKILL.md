...
name: personalizar
description: >
  Ajusta el perfil de práctica de Consultorio Jurídico sin repetir la entrevista completa: cambiar
...
# Personalizar — Consultorio Jurídico

## Qué hace

Edita `~/.claude/plugins/config/claude-legal-colombia/consultorio-juridico-co/CLAUDE.md` (y `~/.claude/plugins/config/claude-legal-colombia/perfil-organizacion.md` cuando el cambio es
...
Decir: «Todavía no hay perfil que ajustar. ¿Corremos `/consultorio-juridico-co:entrevista-inicial`?»
