...
description: >
  Compuerta de verificación de fuentes para Consultorio Jurídico. Toma una pieza ya redactada —un
...
# Verificar citas — Consultorio Jurídico
...
Toda cita confirmada se anota en `~/.claude/plugins/config/claude-legal-colombia/consultorio-juridico-co/bitacora-verificacion.md` para que la
