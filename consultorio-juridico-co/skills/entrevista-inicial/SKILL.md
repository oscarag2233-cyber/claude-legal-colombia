...
description: >
  Entrevista de arranque del plugin Consultorio Jurídico. Levanta el perfil de la organización, el
...
2. `~/.claude/plugins/config/claude-legal-colombia/consultorio-juridico-co/CLAUDE.md` — el perfil de práctica de esta área, a partir de la
...
7. «¿Qué es lo que más tiempo le quita o más problemas le ha traído en Consultorios jurídicos y centros de conciliación universitarios; asistencia jurídica gratuita?»
